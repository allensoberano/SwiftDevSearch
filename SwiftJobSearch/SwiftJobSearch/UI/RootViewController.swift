...
struct RootViewModel {
    ...
    let menuIcons = [
        "info.circle", "magnifyingglass.circle", "music.mic",
        "globe.americas", "headphones", "envelope",
        "person.3"
    ]
}
...
extension RootViewController: ViewContainer {
    ...
    func addCollectionView() {
        ...
        collectionView.register(
            ...
            forCellWithReuseIdentifier: RootViewCollectionViewCell.reuseIdentifer)
...
extension RootViewController: CollectionViewConfiguration {
    ...
    func configureDataSource() {
        dataSource = UICollectionViewDiffableDataSource<Section, String>(
            collectionView: itemsCollectionView) { (collectionView, indexPath, itemName) -> UICollectionViewCell? in

            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: RootViewCollectionViewCell.reuseIdentifer,
                for: indexPath) as? RootViewCollectionViewCell else {
